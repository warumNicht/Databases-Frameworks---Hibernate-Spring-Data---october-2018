...
@Entity
@NamedQuery(name = "BasicIngredient.deleteIngredientByName",query = "DELETE  FROM BasicIngredient   WHERE name=?1")
@NamedQuery(name = "BasicIngredient.updateIngredientsPrices",query = "UPDATE   BasicIngredient AS i SET i.price=i.price*1.1")
